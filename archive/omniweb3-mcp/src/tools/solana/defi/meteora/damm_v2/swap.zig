//! Meteora DAMM v2 Swap Tool
//!
//! Creates a swap transaction for a DAMM v2 pool
...
/// Create DAMM v2 swap transaction
///
/// Parameters:
...
pub fn handle(allocator: std.mem.Allocator, args: ?std.json.Value) mcp.tools.ToolError!mcp.tools.ToolResult {
    ...
    const response = Response{
        ...
        .instruction = "swap",
        .note = "Transaction needs user token accounts for input and output tokens.",
    };
