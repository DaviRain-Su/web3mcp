//! Meteora M3M3 Stake-for-Fee Get Pool Tool
...
pub fn handle(allocator: std.mem.Allocator, args: ?std.json.Value) mcp.tools.ToolError!mcp.tools.ToolResult {
    ...
    if (!constants.isProgramId(account_info.?.owner, constants.PROGRAM_IDS.M3M3)) {
        return helpers.errorResult(allocator, "Not a M3M3 Stake-for-Fee pool");
    }
    ...
    const response = Response{
        ...
        .program_id = "FEESngU3neckdwib9X3KWqdL7Mjmqk9XNp3uh5JbP4KP",
        .data_len = data.len,
        .network = network,
        .note = "M3M3 allows staking tokens to earn trading fees from associated DAMM/DLMM pools.",
    };
