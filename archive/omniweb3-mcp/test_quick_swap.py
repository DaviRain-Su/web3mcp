#!/usr/bin/env python3
"""Quick swap test without confirmation"""
import json
import subprocess
import time
import threading
...
def main():
    print("🚀 Quick swap test (no confirmation)...\n")
    ...
    try:
        ...
        print("🚀 Executing swap WITHOUT confirmation...")
        ...
        data, error = call_tool(proc, "call_contract", {
            ...
            "network": "testnet",
            "tx_type": "legacy",
            "confirmations": 0  # Don't wait for confirmation
        })
