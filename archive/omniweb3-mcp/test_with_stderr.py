#!/usr/bin/env python3
"""Test contract lookup with stderr capture"""
import json
import subprocess
import time
import threading
...
def main():
    print("Starting MCP server with stderr capture...")
    ...
    try:
        ...
        # Try contract lookup
        print("\n📍 Calling call_contract with pancake_testnet...")
        ...
        data, error = call_tool(proc, "call_contract", {
            ...
            "args": ["1000000000000000", [WBNB, BUSD]],
            "network": "testnet",
        ...
        time.sleep(1)  # Let all stderr flush
