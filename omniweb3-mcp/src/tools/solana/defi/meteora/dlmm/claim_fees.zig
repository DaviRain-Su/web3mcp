//! Meteora DLMM Claim Fees Tool
//!
//! Creates a transaction to claim swap fees from a DLMM position
...
pub fn handle(allocator: std.mem.Allocator, args: ?std.json.Value) mcp.tools.ToolError!mcp.tools.ToolResult {
    ...
    const response = Response{
        ...
        .note = "Transaction needs position bin data to claim from all bins with fees. Include user token accounts for X and Y.",
    };
